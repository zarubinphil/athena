...
Ты начинаешь с пустого Mac и набираешь одну команду. Дальше Athena делает всё сама, шаг за шагом — каждый шаг автоматический, по порядку и с проверкой. Если что-то не поднялось — прогон останавливается и говорит об этом; ты никогда не остаёшься с полусобранной машиной, которая делает вид, что всё в порядке.

<p align="center">
  <img src="docs/assets/journey-diagram.png" alt="Шаг за шагом: от пустого Mac до готовой системы" width="100%">
</p>

> Подписи на схемах — на английском (универсально); текст рядом всё поясняет.
...
<p align="center">
  <img src="docs/assets/planes-diagram.png" alt="Сознание, Знания и Работа — три плоскости" width="100%">
</p>
...
<p align="center">
  <img src="docs/assets/layers-diagram.png" alt="Слои, от Базы до Проверок" width="100%">
</p>

| Слой | Что настраивает |
|---|---|
| **0 · Base** | базовые CLI-инструменты (`claude`, `codex`, `git`, `node`, `python`…) |
| **0b · Tools** | дополнения вроде ботов, ставятся до правил, чтобы успеть подключиться |
| **1 · Consciousness** | правила, привычки и помощники ассистента |
| **2 · Registry** | поисковая карта всех навыков и инструментов — нужный находится быстро |
| **3 · Work** | клонирует и ставит твои проекты |
| **4 · Knowledge** | восстанавливает личную библиотеку |
| **5 · Runtime** | секреты (в Keychain macOS) и фоновые помощники |
| **6 · Checks** | гоняет финальные проверки, что всё реально работает |
...
<p align="center">
  <img src="docs/assets/merge-diagram.png" alt="Публичный скелет плюс приватный слой сливаются в твою машину" width="100%">
</p>
...
<p align="center">
  <img src="docs/assets/token-diagram.png" alt="Без карты: блуждание. С Athena: прямой путь." width="100%">
</p>
