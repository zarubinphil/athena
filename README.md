...
| Плоскость | Дом | Что |
|---|---|---|
| **Мозг** (агент-ОС) | `~/.claude` · `~/.codex` · `~/.agents` | конституция, rules, hooks, agents, реестр SSOT — через chezmoi |
| **Знания** | `~/Полезные знания` | durable-знание по методу Карпаты, приватный репо |
...
1  Мозг        chezmoi разворачивает ~/.claude · ~/.codex · ~/.agents
